(function (exports) {
    ...
    ***************************************************************************** */
     ...
     * @returns {string}
     */
    Query.vectorDot = (attribute, vector) => new Query('vectorDot', attribute, [
        vector,
    ]).toString();
    /**
     ...
     * @returns {string}
     */
    Query.vectorCosine = (attribute, vector) => new Query('vectorCosine', attribute, [
        vector,
    ]).toString();
    /**
     ...
     * @returns {string}
     */
    Query.vectorEuclidean = (attribute, vector) => new Query('vectorEuclidean', attribute, [
        vector,
    ]).toString();
    /**
    ...
    class Client {
        constructor() {
            ...
            this.realtime = {
                ...
                createSocket: () => {
                    ...
                    if (this.config.jwt) {
                        queryParams +=
                            '&jwt=' + encodeURIComponent(this.config.jwt);
                    }
                        ...
                        switch (message.type) {
                            case 'connected': {
                                ...
                                if (!session) {
                                    ...
                                    session =
                                        cookie === null || cookie === void 0 ? void 0 : cookie[`a_session_${this.config.project}`];
                                }
        ...
        chunkedUpload(method_1, url_1) {
            return __awaiter(this, arguments, void 0, function* (method, url, headers = {}, originalPayload = {}, onProgress) {
                ...
                const response = yield this.call(method, url, firstChunkHeaders, firstPayload);
                ...
                const isUploadComplete = (chunkResponse) => {
                    ...
                    return (typeof chunksUploaded === 'number' &&
        ...
        call(method_1, url_1) {
            return __awaiter(this, arguments, void 0, function* (method, url, headers = {}, params = {}, responseType = 'json') {
                ...
                if (warnings) {
                    warnings
                        .split(';')
                        .forEach((warning) => console.warn('Warning: ' + warning));
                }
                ...
                if (400 <= response.status) {
                    let responseText;
                    if (((_b = response.headers
                        .get('content-type')) === null || _b === void 0 ? void 0 : _b.includes('application/json')) ||
    ...
    class Account {
        ...
        listConsents(paramsOrFirst, ...rest) {
            let params;
            if ((typeof paramsOrFirst === 'undefined' && rest.length === 0) ||
                (paramsOrFirst &&
                    typeof paramsOrFirst === 'object' &&
                    !Array.isArray(paramsOrFirst))) {
                params = (paramsOrFirst || {});
        ...
        createJWT(paramsOrFirst) {
            let params;
            if (typeof paramsOrFirst === 'undefined' ||
                (paramsOrFirst &&
                    typeof paramsOrFirst === 'object' &&
                    !Array.isArray(paramsOrFirst))) {
                params = (paramsOrFirst || {});
    ...
    class Databases {
        ...
        decrementDocumentAttribute(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/databases/{databaseId}/collections/{collectionId}/documents/{documentId}/{attribute}/decrement'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{collectionId}', encodeURIComponent(String(collectionId)))
                .replace('{documentId}', encodeURIComponent(String(documentId)))
        ...
        incrementDocumentAttribute(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/databases/{databaseId}/collections/{collectionId}/documents/{documentId}/{attribute}/increment'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{collectionId}', encodeURIComponent(String(collectionId)))
                .replace('{documentId}', encodeURIComponent(String(documentId)))
                .replace('{attribute}', encodeURIComponent(String(attribute)));
    ...
    class DocumentsDB {
        ...
        getTransaction(paramsOrFirst) {
            ...
            const apiPath = '/documentsdb/transactions/{transactionId}'.replace('{transactionId}', encodeURIComponent(String(transactionId)));
            const payload = {};
            const uri = new URL(this.client.config.endpoint + apiPath);
            const apiHeaders = {
                'X-Appwrite-Project': this.client.config.project,
        ...
        createOperations(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/documentsdb/transactions/{transactionId}/operations'.replace('{transactionId}', encodeURIComponent(String(transactionId)));
            const payload = {};
            if (typeof operations !== 'undefined') {
                payload['operations'] = operations;
            }
        ...
        listDocuments(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/documentsdb/{databaseId}/collections/{collectionId}/documents'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{collectionId}', encodeURIComponent(String(collectionId)));
            const payload = {};
            if (typeof queries !== 'undefined') {
        ...
        getDocument(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/documentsdb/{databaseId}/collections/{collectionId}/documents/{documentId}'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{collectionId}', encodeURIComponent(String(collectionId)))
                .replace('{documentId}', encodeURIComponent(String(documentId)));
            const payload = {};
        ...
        decrementDocumentAttribute(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/documentsdb/{databaseId}/collections/{collectionId}/documents/{documentId}/{attribute}/decrement'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{collectionId}', encodeURIComponent(String(collectionId)))
                .replace('{documentId}', encodeURIComponent(String(documentId)))
                .replace('{attribute}', encodeURIComponent(String(attribute)));
        ...
        incrementDocumentAttribute(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/documentsdb/{databaseId}/collections/{collectionId}/documents/{documentId}/{attribute}/increment'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{collectionId}', encodeURIComponent(String(collectionId)))
                .replace('{documentId}', encodeURIComponent(String(documentId)))
                .replace('{attribute}', encodeURIComponent(String(attribute)));
    ...
    class TablesDB {
        ...
        decrementRowColumn(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/tablesdb/{databaseId}/tables/{tableId}/rows/{rowId}/{column}/decrement'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{tableId}', encodeURIComponent(String(tableId)))
                .replace('{rowId}', encodeURIComponent(String(rowId)))
        ...
        incrementRowColumn(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/tablesdb/{databaseId}/tables/{tableId}/rows/{rowId}/{column}/increment'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{tableId}', encodeURIComponent(String(tableId)))
                .replace('{rowId}', encodeURIComponent(String(rowId)))
                .replace('{column}', encodeURIComponent(String(column)));
    ...
    class VectorsDB {
        ...
        listDocuments(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/vectorsdb/{databaseId}/collections/{collectionId}/documents'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{collectionId}', encodeURIComponent(String(collectionId)));
            const payload = {};
            if (typeof queries !== 'undefined') {
        ...
        createQuery(paramsOrFirst, ...rest) {
            let params;
            if (paramsOrFirst &&
                typeof paramsOrFirst === 'object' &&
                !Array.isArray(paramsOrFirst)) {
            ...
            const apiPath = '/vectorsdb/{databaseId}/collections/{collectionId}/documents/query'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{collectionId}', encodeURIComponent(String(collectionId)));
            const payload = {};
            if (typeof queries !== 'undefined') {
        ...
        getDocument(paramsOrFirst, ...rest) {
            ...
            const apiPath = '/vectorsdb/{databaseId}/collections/{collectionId}/documents/{documentId}'
                .replace('{databaseId}', encodeURIComponent(String(databaseId)))
                .replace('{collectionId}', encodeURIComponent(String(collectionId)))
                .replace('{documentId}', encodeURIComponent(String(documentId)));
            const payload = {};
    ...
    class Realtime {
        ...
        channelToString(channel) {
            ...
            // All Channel instances have toString() method
            if (channel &&
                typeof channel.toString === 'function') {
                ...
                const update = (changes) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (changes.queries !== undefined) {
                        ...
                        for (const q of changes.queries) {
                            if (Array.isArray(q)) {
                                for (const inner of q) {
                                    nextQueries.push(typeof inner === 'string'
                                        ? inner
                                        : inner.toString());
                                }
                            }
    ...
    exports.ExecutionResourceType = void 0;
    (function (ExecutionResourceType) {
        ExecutionResourceType["Functions"] = "functions";
        ExecutionResourceType["Sites"] = "sites";
    })(exports.ExecutionResourceType || (exports.ExecutionResourceType = {}));
